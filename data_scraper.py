...
def currency_course():
    ...
    url_eur_usd = f"https://www.xe.com/currencyconverter/convert/?Amount={amount}&From={sell[1]}&To={buy[2]}"
    ...
    eur_usd_page = requests.get(url_eur_usd, headers=headers)
